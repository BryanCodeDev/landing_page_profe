...
import { BarChart3, Download, BookOpen, Layers, Search, X } from 'lucide-react'
              ...
              <div className="mt-6 max-w-xl">
                <div className="relative">
                  ...
                  <input
                    ...
                    aria-label="Buscar ejercicios de Excel"
                    className="
                ...
                <div className="space-y-3">
                  {flatResults.map((exercise, index) => (
                    <div key={exercise.id} className="flex items-start gap-3">
                      <span className="shrink-0 w-6 h-6 rounded-full bg-emerald-100 text-emerald-600 text-xs font-bold flex items-center justify-center mt-1">
                        {index + 1}
                      </span>
